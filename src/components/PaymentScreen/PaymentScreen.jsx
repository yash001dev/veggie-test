...
import { ORDER_RESET,ORDER_CREATE_SUCCESS } from "../../redux/constants/orderConstants";
...
const PaymentScreen = ({getBasket}) => {
  ...
  const basketNo = getBasket === 'b1' ? 1 : getBasket === 'b2' ? 2 : getBasket === 'b3' ? 3 : 0;
    ...
    if (localStorage.getItem("isAddress") === "true") {
      if (JSON.parse(localStorage.getItem("itemsPrice")) > 0) {
        ...
        if (paymentMethod === "razorpay") {
          ...
          placedOrder["user_address_id"] = orderAddress.user_address_id ? orderAddress.user_address_id : 1;
